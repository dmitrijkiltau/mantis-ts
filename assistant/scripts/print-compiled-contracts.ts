...
const prompts = [
  ...
  orchestrator.buildAnswerPrompt('Here is a response', 'tool-formatting', 'en', undefined, { requestContext: 'Not provided.', toolName: 'Not specified', response: 'Here is a response' }),
